...
var Gauge = /** @class */ (function (_super) {
    ...
    Gauge.prototype.drawDelta = function () {
        ...
        var delta = this.getDelta();
        if (!delta) {
            var deltaGroup = svg.select('g.gauge-delta');
            if (!deltaGroup.empty()) {
                deltaGroup.remove();
            }
        }
            ...
            var gaugeSymbol_1 = showPercentageSymbol ? '%' : '';
            ...
            deltaNumber
                ...
                .text(function (d) { return "" + numberFormatter_1(d) + gaugeSymbol_1; });

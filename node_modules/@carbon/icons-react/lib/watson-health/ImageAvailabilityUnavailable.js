...
const ImageAvailabilityUnavailable = /*#__PURE__*/React__default["default"].forwardRef(function ImageAvailabilityUnavailable(_ref, ref) {
  let {
    children,
    size = 16,
    ...rest
...
if (process.env.NODE_ENV !== "production") {
  ImageAvailabilityUnavailable.propTypes = iconPropTypes.iconPropTypes;
}

module.exports = ImageAvailabilityUnavailable;

...
const ComboBox = /*#__PURE__*/React__default["default"].forwardRef((props, ref) => {
  ...
  const className = cx__default["default"](`${prefix}--combo-box`, [enabled ? null : containerClassName], {
  ...
  const wrapperClasses = cx__default["default"](`${prefix}--list-box__wrapper`, [enabled ? containerClassName : null, {

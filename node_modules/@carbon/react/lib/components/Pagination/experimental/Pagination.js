...
function Pagination(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("section", _rollupPluginBabelHelpers["extends"]({
  ...
  }, pageSizes.map(size => /*#__PURE__*/React__default["default"].createElement(SelectItem["default"], {
    key: size,
    value: size,
    text: String(size)
    ...
    kind: "ghost",
    className: cx__default["default"](`${namespace}__button`, `${namespace}__button--backward`, {
    ...
    kind: "ghost",
    className: cx__default["default"](`${namespace}__button`, `${namespace}__button--forward`, {

...
const TextInput = /*#__PURE__*/React__default["default"].forwardRef(function TextInput(_ref, ref) {
  ...
  const [textCount, setTextCount] = React.useState((defaultValue === null || defaultValue === void 0 ? void 0 : defaultValue.toString().length) || (value === null || value === void 0 ? void 0 : value.toString().length) || 0);
  ...
  const textInputClasses = cx__default["default"](`${prefix}--text-input`, [enabled ? null : className], {

...
const FilterableMultiSelect = /*#__PURE__*/React__default["default"].forwardRef(function FilterableMultiSelect(_ref, ref) {
  ...
  const wrapperClasses = cx__default["default"](`${prefix}--multi-select__wrapper`, `${prefix}--multi-select--filterable__wrapper`, `${prefix}--list-box__wrapper`, [enabled ? containerClassName : null], {
  ...
  return /*#__PURE__*/React__default["default"].createElement(Selection["default"], {
    ...
    render: _ref3 => {
      ...
      return /*#__PURE__*/React__default["default"].createElement(Downshift__default["default"], _rollupPluginBabelHelpers["extends"]({}, downshiftProps, {
        ...
        const className = cx__default["default"](`${prefix}--multi-select`, `${prefix}--combo-box`, `${prefix}--multi-select--filterable`, [enabled ? null : containerClassName], {
        ...
        return /*#__PURE__*/React__default["default"].createElement("div", {
          ...
          isOpen: isOpen,
          translateWithId: translateWithId
        }))), isOpen ? /*#__PURE__*/React__default["default"].createElement(index$1["default"].Menu, menuProps, sortItems(filterItems(items, {
          itemToString,
          inputValue
        }), {
          selectedItems: {

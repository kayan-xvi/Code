...
const MultiSelect = /*#__PURE__*/React__default["default"].forwardRef(function MultiSelect(_ref, ref) {
  ...
  const {
    ...
    getItemProps,
    selectedItem
  } = Downshift.useSelect({ ...downshiftProps,
    highlightedIndex,
    isOpen,
    itemToString: items => {
  ...
  const className = cx__default["default"](`${prefix}--multi-select`, [enabled ? null : containerClassName], {
  ...
  }, clearSelectionDescription, " ", selectedItems.length, ",", clearSelectionText)), /*#__PURE__*/React__default["default"].createElement(index$1["default"], {
...
MultiSelect.propTypes = { ...MultiSelectPropTypes.sortingPropTypes,

...
function TreeView(_ref) {
  ...
  const treeWalker = React.useRef(treeRootRef === null || treeRootRef === void 0 ? void 0 : treeRootRef.current);
  const [selected, setSelected] = React.useState(preselected);
  const [active, setActive] = React.useState(prespecifiedActive);

  function resetNodeTabIndices() {
    var _treeRootRef$current;
  ...
  React.useEffect(() => {
    treeWalker.current = treeWalker.current ?? document.createTreeWalker(treeRootRef === null || treeRootRef === void 0 ? void 0 : treeRootRef.current, NodeFilter.SHOW_ELEMENT, {

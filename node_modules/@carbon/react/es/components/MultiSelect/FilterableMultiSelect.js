...
const FilterableMultiSelect = /*#__PURE__*/React__default.forwardRef(function FilterableMultiSelect(_ref, ref) {
  ...
  const wrapperClasses = cx(`${prefix}--multi-select__wrapper`, `${prefix}--multi-select--filterable__wrapper`, `${prefix}--list-box__wrapper`, [enabled ? containerClassName : null], {
  ...
  return /*#__PURE__*/React__default.createElement(Selection, {
    ...
    render: _ref3 => {
      ...
      return /*#__PURE__*/React__default.createElement(Downshift, _extends({}, downshiftProps, {
        ...
        const className = cx(`${prefix}--multi-select`, `${prefix}--combo-box`, `${prefix}--multi-select--filterable`, [enabled ? null : containerClassName], {

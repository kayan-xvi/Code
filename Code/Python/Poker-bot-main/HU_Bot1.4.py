...
def betting(p_chips, c_chips, p_inter, c_inter, pot): 
    '''
    This function deals with the betting of the player each time they have a decision 
    '''
    p_turns = 0 
    c_turns = 0 
    while p_inter != c_inter or p_turns != c_turns:
        p_turns += 1 
...
def heads_up_prob(): 
    ...
    board_cards(p_hand, c_hand, board, deck, remaining, 'flop', 3)
    board_cards(p_hand, c_hand, board, deck, remaining, 'turn', 1)
    board_cards(p_hand, c_hand, board, deck, remaining, 'river', 1)
...
#p_chips, c_chips, p_inter, c_inter, pot = pot(1000)
heads_up_prob()

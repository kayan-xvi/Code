...
def heads_up_prob(): 
    ...
    position(c_hand, board, remaining) 
...
def five_card_draw(draws): 
    ...
    cards = []
    cards, cards_print, deck = make_hand(deck, cards, 5)
    print('\nYour hand:')
    print(cards_print)
    cards = convert(cards)
    cards_strength = hand_value(cards)
    ...
    for i in range(draws):
        replace_cards(cards, deck)

#---------------------

def five_card_draw_prob(draws): 
    deck = make_deck() 
    remaining = make_deck()
    cards = []
    cards, cards_print, deck = make_hand(deck, cards, 5)
    ...
    print('\nYour hand:')
    print(cards_print)
    print('Number of cards reminaing: {}'.format(len(remaining)))
    cards = convert(cards)
    cards_strength = hand_value(cards)
    classif, power = hand_type(cards_strength)
    print(classif)

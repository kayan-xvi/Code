...
def checkValidity(x,y,parentx,parenty): 
    ...
    if 0 <= x < maze.width:
        ...
        if 0 <= y < maze.height: 
            ...
            if maze.layout[y][x] <= maze.layout[parenty][parentx] + 1: 
                #print('test2')
...
while maze.layout[frontier.info[list(frontier.info.keys())[0]]['y']][frontier.info[list(frontier.info.keys())[0]]['x']] != 27: 
